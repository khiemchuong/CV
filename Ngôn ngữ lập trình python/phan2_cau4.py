...
def cau4_1():
    ...
    rosen_surf=ax.plot_surface(x,y,z,cmap= cm.Blues,linewidth=0,antialiased=False)
...
def cau4_2():
    ...
    fig,ax=plt.subplots(subplot_kw={"projection":"3d"})
    rosen_surf=ax.plot_surface(x,y,z,cmap=plt.cm.YlGnBu_r,linewidth=0,antialiased=False)
    rosen_surf=ax.plot_surface(x,y,z1,cmap=plt.cm.YlGnBu_r,linewidth=0,antialiased=False)
    ax.set_zlim(-10,10)
